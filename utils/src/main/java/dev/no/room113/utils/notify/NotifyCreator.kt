package dev.no.room113.utils.notify

import android.annotation.TargetApi
import android.os.Build
import androidx.core.app.NotificationCompat
import dev.no.room113.utils.notify.entities.Payload
import dev.no.room113.utils.notify.internal.RawNotification
import dev.no.room113.utils.notify.internal.utils.Action
import dev.no.room113.utils.notify.internal.utils.Errors
import dev.no.room113.utils.notify.internal.utils.Experimental
import dev.no.room113.utils.notify.internal.utils.NotifyScopeMarker
...
//     */
//    @Deprecated(
//        message = "Removed optional argument to alleviate confusion on ID that is used to create notification",
//        replaceWith = ReplaceWith(
//            "Notify.show()",
//            "dev.no.room113.utils.notify.Notify",
//        ),
//    )
//    fun show(id: Int?): Int {
...
//        return Notify.cancelNotification(context, id)
//    }
}
